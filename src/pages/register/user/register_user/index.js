...
class Register extends React.Component {
    ...
    async componentDidMount() {
        const response = await api.get("/Republica/VerRepublica", {
            cdRepublica: 1, 
        });
    ...
    handleSubmit(event) {
        document.location.href = "/register/user/picture/doc"  
                            ...
                            <Body style={{marginTop:"30px"}}>
                                <form action="submit" method="POST" onSubmit={this.handleSubmit}>
                                    <div>   
                                        ...
                                        <Input onChange={ this.handleTextChange } name="cepFac" value={ this.state.cepFac } 
                                        type="text" placeholder="CEP da faculdade"></Input>
