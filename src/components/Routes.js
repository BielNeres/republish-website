...
import Register_republic_1 from '../pages/register/republic/register_republic_1'
...
const Routes = () => (
    <Router history={history}>
        <Switch>
            ...
            <Route component={Register_republic_1} exact path="/register/republic/step/1"/>
            <Route component={Register_republic_2} exact path="/register/republic/step/2"/>
            <Route component={Register_login} exact path="/register/user"/>
            <Route component={picture_doc} exact path="/register/picture/doc"/>
            <Route component={picture_perfil} exact path="/register/picture/perfil"/>
            <Route component={description} exact path="/register/description"/>
